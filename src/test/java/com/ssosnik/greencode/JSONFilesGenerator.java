...
public class JSONFilesGenerator {
    ...
    private static final File ATM_SERVICE_FOLDER_INPUT = new File("src/test/resources/testing-files/atmservice/request");
    private static final File ATM_SERVICE_FOLDER_OUTPUT = new File("src/test/resources/testing-files/atmservice/response");
